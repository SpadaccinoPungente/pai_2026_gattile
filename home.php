...
<p>Ogni anno centinaia di felini cercano una famiglia o cure adeguate. Il nostro portale ti permette di adottare un
    gatto o di offrire il tuo tempo prezioso come volontario presso la nostra struttura.</p>
    ...
    <?php if ($risultato && $risultato->num_rows > 0): ?>
        <?php while ($gatto = $risultato->fetch_assoc()): ?>
            <div class="card-gatto">
                ...
                <small class="testo-secondario">Arrivato il:
                    <?php echo date("d/m/Y", strtotime($gatto['data_arrivo'])); ?></small>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
